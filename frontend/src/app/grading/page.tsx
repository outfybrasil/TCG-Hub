            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-12 order-1 lg:order-2">
                    <div className="space-y-6">
                        ...
                        <p className="text-slate-500 font-medium text-sm leading-relaxed max-w-md">Nosso laboratório digital utiliza o NeuralScan v.2.4 para mapear imperfeições micrométricas, garantindo a nota mais justa para cada item da nossa TCG Mega Store.</p>
                    </div>
