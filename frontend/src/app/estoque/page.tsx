    ...
    useEffect(() => {
        ...
        const fetchUserCards = async (userId: string) => {
            try {
                ...
                setCards(response.documents.map(doc => ({
                    id: doc.$id,
                    name: doc.name || "Ativo Desconhecido",
                    set: doc.set || "Arquivo Nulo",
                    imageUrl: doc.imageUrl || "https://images.pokemontcg.io/base1/4.png",
                    price: doc.price || 0,
                    grade: doc.grade || "NM",
                    finish: doc.finish || "Normal",
                    isPromo: doc.isPromo || false
                })));
            } catch (error) {
            ...
            <div className="max-w-7xl mx-auto px-6 py-32 text-center animate-fade-up">
                <div className="max-w-md mx-auto space-y-8 bg-white p-12 rounded-[32px] border border-slate-200 shadow-sm">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-slate-400 font-bold text-[10px] uppercase tracking-widest leading-relaxed">Apenas o administrador da TCGStore pode gerenciar o estoque global.</p>
                    </div>
