        ...
        <div className="min-h-[85vh] flex items-center justify-center p-6 bg-white animate-fade-up">
            <div className="w-full max-w-md">
                <div className="text-center mb-10 space-y-4">
                    ...
                    <p className="text-slate-400 font-bold text-[10px] uppercase tracking-[0.4em]">Protocolo de Autenticação TCGStore</p>
                </div>
                ...
                <div className="bg-white border border-slate-100 p-8 sm:p-12 rounded-[40px] shadow-[0_30px_60px_rgba(0,0,0,0.05)] relative overflow-hidden">
                    <form onSubmit={handleLogin} className="space-y-6 relative z-10">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                placeholder="exemplo@tcgstore.com"
                    ...
                    <div className="mt-10 text-center border-t border-slate-50 pt-10">
                        <p className="text-[10px] text-slate-400 font-black uppercase tracking-[0.2em]">
                            Novo colecionador? <button type="button" className="text-rose-600 hover:text-rose-700 transition-colors">Criar Conta de Cliente</button>
                        </p>
                    </div>
                </div>
