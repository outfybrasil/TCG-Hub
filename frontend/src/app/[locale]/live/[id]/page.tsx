            ...
            <div className="live-mobile-auction absolute bottom-0 left-0 right-16 z-10 p-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
                {!waiting && !ended && <>
                    <div className="mb-3 flex items-end gap-3">
                        {live.current_item_image && <div className="relative h-20 w-16 shrink-0 overflow-hidden rounded-xl border border-white/20 bg-black/40"><Image unoptimized fill sizes="64px" src={live.current_item_image} alt={live.current_item_name || 'Lote'} className="object-contain" /></div>}
